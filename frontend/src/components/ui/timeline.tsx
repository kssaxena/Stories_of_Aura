...
export const Timeline = ({ data }) => {
  ...
  return (
    <div
      className="w-full dark:bg-transparent md:px-10"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto lg:pt-20 md:px-8 lg:px-10">
        <h2 className="lg:text-7xl md:text-5xl text-2xl mx-10 lg:mx-0 mb-4 text-neutral-400 max-w-4xl font-agile tracking-widest border-b border-[#FA2C37]">
          What we do...
        </h2>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-28 w-[2px] bg-gradient-to-t from-red-600 to-red-900  from-[0%] via-[10%] rounded-full h-fit lg:h-full z-20"
          />
        </div>
      </div>
    </div>
